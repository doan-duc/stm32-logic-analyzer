...
Ngày 18/7/2026, lệnh \texttt{INFO} xác nhận xung TIM2 bằng 72~MHz. Chuỗi Gray từ Arduino được dùng làm dữ liệu tham chiếu để kiểm tra tính toàn vẹn của mẫu và độ chính xác tần số ở hai cơ chế thu \cite{hil2026}.
...
\bibitem{hil2026} Nhóm thực hiện, \emph{Kết quả HIL trên STM32F103C8 chạy thạch anh HSE 72~MHz}, ngày 18/7/2026, \path{report/generated/hil_72mhz_summary.md}.
...
def _enhance_content(raw_latex: str) -> str:
    ...
    prose_replacements = (
        ...
        (
            ...
            "Phạm vi đề tài gồm firmware STM32, giao thức khung SLA8, phần mềm máy tính, các bộ giải mã UART, I2C, SPI và chương trình tạo tín hiệu kiểm thử trên Arduino UNO. Phần đánh giá dựa trên kiểm thử HIL thực hiện ngày 18/7/2026.",
        ),
        (
