...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--timer-clock", type=int, default=64_000_000)
    parser.add_argument("--minimum-rate", type=int, default=1_000_000)
    parser.add_argument("--maximum-rate", type=int, default=32_000_000)
    parser.add_argument("--rates", nargs="+", type=int)
    parser.add_argument("--captures", type=int, default=5)
    parser.add_argument("--gray-rate", type=int, default=100_000)
    parser.add_argument("--minimum-states", type=int, default=32)
